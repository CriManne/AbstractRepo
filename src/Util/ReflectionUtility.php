...
use AbstractRepo\Exceptions\NotImplementedException;
...
final class ReflectionUtility{
    ...
    /**
     * Returns the reflected property with the attribute Key
     * 
    ...
    static public function getKeyProperty(string $modelClass):ReflectionProperty{        
        $properties = ReflectionUtility::getPropertyWithAttribute($modelClass,Key::class);

        if(count($properties)==0) throw new ReflectionException("No Key property defined in $modelClass");

        return $properties[0];
    }

    /**
     * Returns the reflected properties with the attribute Key
     *
     * @param string $modelClass
     * @return array
     */
    ...
    /**
     * Returns the reflected properties with the attribute ForeignKey
     *
     * @param string $modelClass
     * @return array
     */
    static public function getFkProperties(string $modelClass):array{
        ...
        $properties = ReflectionUtility::getPropertyWithAttribute($modelClass,ForeignKey::class);        
        return $properties;
    }
    ...
    static public function getProperty(string $modelClass,string $propertyName): ReflectionProperty{
        ...
        throw new ReflectionException(ReflectionException::$PROPERTY_NOT_FOUND);
    }
